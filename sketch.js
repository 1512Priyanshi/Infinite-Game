...
//text("life: "+ life , 500,60);
  ...
  // score = score + Math.round(getFrameRate()/60);
    ...
    // the game state should be in end when mario touches the obstacles and life should decrease by 1
   if(obstaclesGroup.isTouching(mario)){
     life=life-1;
        gameState = END;
    } 
    
    // if coings touch mario coin sound should be played and score should increment to 1
  ...
  // if gamestate is end restart and gameover iconn should be displayed and mario animation should change
...
function reset(){
  ...
  // when the gamestate is play gameover should be visible
  gameState = PLAY;
  gameOver.visible = false;
  restart.visible = false;
  
  // obstacles and coins should get destroyed
